...
public class PDFTests extends BaseTests {
    ...
    public void testInvoices() throws IOException, InterruptedException {
        ...
        generatorPage.setLogo(new File("E:/Marwen/Test_auto/Visual_testing/img/logo.png"));
        ...
        File downloadedPDF = new File("E:/Marwen/Test_auto/Visual_testing/pdf.jar" + invoiceNumber + ".pdf");
        String destination = "ressource/Invoice_PDFs/" + invoiceNumber + ".pdf";
